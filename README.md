...
✅ **Notes**
- Uses **quadruple backticks** in chat to preserve triple ones for GitHub rendering.
- Paste directly into your `README.md` — GitHub will render the Mermaid flowchart automatically.
